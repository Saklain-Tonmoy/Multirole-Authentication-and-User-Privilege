        ...
        <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Fill up the form below</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="{{route('adminupdate.user', $user->id)}}">
                  @csrf
                  @method('put')
                <div class="card-body">
                    <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{$user->name}}" class="form-control" id="username" placeholder="Fullname"/>
                    @error('name')
